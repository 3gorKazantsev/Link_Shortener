...
insert into users (id, created_at, username, first_name, last_name, password, is_active) values (1, now(), 'admin', 'admin_fn', 'admin_ln', 'pass', true);
insert into users (id, created_at, username, first_name, last_name, password, is_active) values (2, now(), 'user', 'user_fn', 'user_ln', 'pass', true);
